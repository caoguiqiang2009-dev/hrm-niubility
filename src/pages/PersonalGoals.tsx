      ...
      <SmartTaskModal
        ...
        initialData={(() => {
          ...
          return {
            ...
            m: editingPlan.target_value ? editingPlan.target_value.split('\n')[1]?.replace('M: ', '') : '',
            t: editingPlan.deadline || editingPlan.target_value?.split('\n')[2]?.replace('T: ', '') || '',
      ...
      <SmartTaskModal
        ...
        initialData={(() => {
          ...
          return {
            ...
            s: selectedPlan.target_value ? selectedPlan.target_value.split('\n')[0]?.replace('S: ', '') : '',
            m: selectedPlan.target_value ? selectedPlan.target_value.split('\n')[1]?.replace('M: ', '') : '',
            t: selectedPlan.deadline || selectedPlan.target_value?.split('\n')[2]?.replace('T: ', '') || '',
            a_smart: decoded.resource,
            r_smart: decoded.relevance,
